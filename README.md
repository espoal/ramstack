...
Having predictable performance is a feature, that need to be tested against in the CI/CD pipeline, to spot early regression that should be considered bugs. On the other hand being fast will drive your conversion rates up, as research has confirmed [1] [2] [3] . 

### Availability means trust

Performance and availability are the one-two punch to driv
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUxODIxNTU5NCwxNDU0MjE3MTU3LDEwMz
